...
namespace NetCoreApp.Migrations
{
    ...
    [Migration("20190223182349_InitialDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCoreApp.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NetCoreApp.Data.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NetCoreApp.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("NetCoreApp.Data.Entities.Order", "Order")
                        .WithMany("Items")
